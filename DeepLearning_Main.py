...
# ==========================================
def prepare_dataloaders(df, sampler_flag, batches=32, workers=0):
    ...
    weights = [weight_malignant if label == 1 else weight_benign for label in train_df['label']]
...
def Run_Model(Data, device, model_name, pretrained_model_path, save_path):
    ...
    train_loader, val_loader, test_loader = prepare_dataloaders(df, sampler_flag, batches, workers)
