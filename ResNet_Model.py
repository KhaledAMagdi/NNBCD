...
# ==========================================
# 2. DataLoaders & Splitting (Patient-Safe)
# ==========================================
...
# ==========================================
def build_resnet_model(device, retrain, L4_flag, weights_path):
...
def train_model(model, train_loader, val_loader, device,
    ...
    for name, BM in Best_Models.items():
        ...
        print(
            f"Info     | Epoch:  {BM['epoch']:2}/{epochs}  | Threshold:  {threshold}     | LR: {BM['learning_rate']:.8f}")
...
# 5. Main Execution
# ==========================================
def ResNet_Model(Data, device, pretrained_model_path, save_path):
    ...
    model = build_resnet_model(**model_kwargs)
